...
#    Updated: 2022/11/09 23:14:17 by himejjad         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_strlcpy.c ft_tolower.c ft_bzero.c ft_memcpy.c ft_calloc.c ft_strdup.c\
ft_putnbr_fd.c ft_strlen.c ft_striteri.c ft_atoi.c ft_memcmp.c\
